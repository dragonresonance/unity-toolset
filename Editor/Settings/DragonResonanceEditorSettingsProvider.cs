...
namespace DragonResonance.Editor.Settings
{
	public class DragonResonanceEditorSettingsProvider : SettingsProvider
	{
		...
		private const int LargePadding = 36;
		...
		#region Publics
			...
			public override void OnGUI(string searchContext)
			{
				...
				GUIStyle fullSection = new() { padding = new RectOffset(LargePadding, LargePadding, LargePadding, LargePadding) };
				GUIStyle separatedSection = new() { padding = new RectOffset(LargePadding, LargePadding, SmallPadding, SmallPadding) };
				...
				EditorGUILayout.BeginVertical(fullSection);
				{
					...
					EditorGUILayout.LabelField("Copyright © 2021-2026. All rights reserved.", EditorStyles.centeredGreyMiniLabel);
					EditorGUILayout.LabelField("Licensed under the Apache License, Version 2.0.", EditorStyles.centeredGreyMiniLabel);
					EditorGUILayout.LabelField("See LICENSE.md for more info.", EditorStyles.centeredGreyMiniLabel);
